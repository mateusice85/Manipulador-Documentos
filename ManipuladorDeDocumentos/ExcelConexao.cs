...
namespace ManipuladorDeDocumentos
{
    class ExcelConexao
    {
        ...
        public void GerarPlanilha()
        {
            ...
            //Connection string: workstation id=Server666.mssql.somee.com;packet size=4096;user id=mateusice85_SQLLogin_1;pwd=zj9s13t57e;data source=Server666.mssql.somee.com;persist security info=False;initial catalog=Server666
        }
